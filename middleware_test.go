	...
	}{
		{
			...
			Request: fakeRequest{
				...
				TokenClaims: jose.Claims{
					"sub":                "test-subject",
					"username":           "Chandu",
					"preferred_username": "Chandu",
					"email":              "chandu.nalluri@transunion.com",
				},
				ExpectedProxyHeaders: map[string]string{
					"X-Auth-Subject":  "test-subject",
					"X-Auth-Userid":   "Chandu",
					"X-Auth-Email":    "chandu.nalluri@transunion.com",
					"X-Auth-Username": "Chandu",
				},
				ExpectedProxy: true,
				ExpectedCode:  http.StatusOK,
			},
		},
		{
			...
			Request: fakeRequest{
				...
				TokenClaims: jose.Claims{
					...
					"name":               "Chandu Nalluri",
					"family_name":        "Nalluri",
					"preferred_username": "cnalluri",
					"given_name":         "Chandu",
				},
				ExpectedProxyHeaders: map[string]string{
					"X-Auth-Given-Name":  "Chandu",
					"X-Auth-Family-Name": "Nalluri",
				},
				ExpectedProxy: true,
				ExpectedCode:  http.StatusOK,
			},
